...
export const src = ['https://raw.githubusercontent.com/eyssette/sujets-philosophie-bac/main/data/dissertations.tsv', 'https://raw.githubusercontent.com/eyssette/sujets-philosophie-bac/main/data/explications.tsv'];
...
export function reorganizeDataFunction(arrInit) {
	...
	return arrInit.map(element => [element[0], element[1], element[2] + ' – ' + element[3], element[4]]);
